      ...
      {open && (
        ...
        >
          <div className="flex h-full w-full max-w-md flex-col">
            <header className="flex flex-col gap-1 border-b border-border px-4 py-4">
...
export const inputClassName =
  "w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted disabled:cursor-not-allowed disabled:opacity-60";

export const textareaClassName =
  "w-full resize-none rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted disabled:cursor-not-allowed disabled:opacity-60";
